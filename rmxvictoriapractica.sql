  ...
  ADD COLUMN `porcentaje_desarrollador` DECIMAL(5,2) NULL AFTER `porcentaje_oficina`,
  ADD COLUMN `comision_desarrollador` DECIMAL(10,2) NULL AFTER `comision_oficina`;
