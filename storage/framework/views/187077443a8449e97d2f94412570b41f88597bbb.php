...
<body>
    ...
    <div class="cartas">
        <div class="carta" id="agenda">
            <img src="<?php echo e(asset('images\Group2.svg')); ?>" alt="">
            <h1 class="agenda">Agenda</h1>
        </div>
        <div class="carta" id="circulo">
            <img src="<?php echo e(asset('images\Group3.svg')); ?>" alt="">
    ...
    <script>
        document.getElementById("agenda").addEventListener("click", function() {
            window.location.href = "<?php echo e(route('agendas')); ?>";
        });

        document.getElementById("circulo").addEventListener("click", function() {
            window.location.href = "<?php echo e(route('contactos')); ?>";
        });
        </script>
</body>
</html><?php /**PATH C:\laragon\www\RemaxVictoria\resources\views/menu.blade.php ENDPATH**/ ?>