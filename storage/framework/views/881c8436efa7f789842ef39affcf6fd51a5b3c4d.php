<nav class="navbar custom navbar-expand-lg">
    <div class="container-fluid">
      ...
      <li class="nav-item">
            <a class="nav-link letras" id="nav-item" aria-current="page" href="<?php echo e(route('login')); ?>">Login</a>
          </li>
          </ul>
    </div>
  </div>
...
</nav><?php /**PATH C:\laragon\www\agenda.remaxvictoria.mx\resources\views/navCierre.blade.php ENDPATH**/ ?>